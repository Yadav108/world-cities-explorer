#!/usr/bin/env python3
"""
Urban Analytics Dashboard - HTML Writer
This script writes the complete index.html file with all HTML, CSS, and JavaScript
"""
...
# Write the file
output_path = r'C:\Users\Aryan\PycharmProjects\pythonProject\100 day challenge\index.html'
try:
    ...
    print(f"✓ Successfully wrote index.html ({file_size} bytes)")
